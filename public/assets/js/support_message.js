		...
		$.ajax({
			...
			success:  function(data){
				...
				if(data.status == "success"){
					...
					$("#message").val('');
					var div='<div class="row msg_container base_sent"><div class="col-md-10 col-xs-10"><div class="messages msg_sent"><p style="color:blue;">Support #'+data.details.user+'</p><p>'+data.details.description+'</p>';
					div+='<p class="time_date"><span>Sent: </span>'+data.details.time+'</p></div></div><div class="col-md-2 col-xs-2 avatar"><i class="fa fa-user" aria-hidden="true"></i></div></div>';
					$("#chatdiv").append(div);	
					$.gritter.add({
