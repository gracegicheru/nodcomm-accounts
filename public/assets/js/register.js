...
e.preventDefault();
 ...
 function superedit(id){
            ...
            success: function(data) {
               ...
               $('#addagentdiv').addClass('hidden');
			   $('#editagentdiv').removeClass('hidden');
            ...
            success: function(data) {
               ...
               if(data.status=='error'){
				...
				$('#dataTable').dataTable().fnClearTable();
								...
								$.each(data.details, function(key, value) {
									if(value.active == 1){
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Disable" onclick="disableagent('+value.id+')"  id="disableagentbtn'+value.id+'" class="btn btn-xs btn-danger" style="margin-right:3px;" ><i class="fa fa-times" aria-hidden="true"></i></a>';
										status = 'Active';
									}else{
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable" onclick="enableagent('+value.id+')"  id="enableagentbtn'+value.id+'" class="btn btn-xs btn-success" style="margin-right:3px;" ><i class="fa fa-check" aria-hidden="true"></i></a>';
										status = 'Inactive';
									}
								   if(value.admin == 1){
									   usertype ='Admin';
									   ...
									   usertype ='Agent';
									   link +='<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Login as User" href="'+server+'/login/'+value.id+'" class="btn btn-xs btn-info"> <i class="fa fa-sign-in" aria-hidden="true"></i></a>';
								   }
									 $('#dataTable').dataTable().fnAddData([
									  ...
									  usertype,
									  status,
									  '<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="editagent('+value.id+')"  class="btn btn-info btn-xs" style="margin-right:3px;" id="editagentbtn'+value.id+'"><i class="fa fa-pencil" aria-hidden="true"></i></a>'+link	
...
$("#photo").change(function(e) {
    ...
    $('#step1btn').click(function(e) {
			...
			if(data.status=='error'){
					...
					$('#step1div').addClass('hidden');
					$('#step1success').removeClass('hidden');
            ...
            success: function(data) {
               ...
               if(data.status=='error'){
				...
				$('#dataTable').dataTable().fnClearTable();
								...
								$.each(data.details, function(key, value) {
									if(value.active == 1){
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Disable" onclick="disablesuperadmin('+value.id+')"  id="disablesuperadminbtn'+value.id+'" class="btn btn-xs btn-danger" style="margin-right:3px;" ><i class="fa fa-times" aria-hidden="true"></i></a>';
										status = 'Active';
									}else{
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable" onclick="enablesuperadmin('+value.id+')"  id="enablesuperadminbtn'+value.id+'" class="btn btn-xs btn-success" style="margin-right:3px;" ><i class="fa fa-check" aria-hidden="true"></i></a>';
										status = 'Inactive';
									}
									 ...
									 $('#dataTable').dataTable().fnAddData([
									  ...
									  ''!=null ? value.email  : "",
									  status,
									  '<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="editsuperadmin('+value.id+')"  class="btn btn-info btn-xs" style="margin-right:3px;" id="editsuperadminbtn'+value.id+'"><i class="fa fa-pencil" aria-hidden="true"></i></a>'+link	
