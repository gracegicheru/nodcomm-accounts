               ...
               if(data.status=='error'){
				...
				$('#dataTable').dataTable().fnClearTable();
								...
								$.each(data.details, function(key, value) {
									if(value.active == 1){
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Disable" onclick="disablewebsite('+value.id+')"  id="disablewebsitebtn'+value.id+'" class="btn btn-xs btn-danger" style="margin-right:3px;" ><i class="fa fa-times" aria-hidden="true"></i></a>';
										status = 'Active';
									}else{
										link ='<a   data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable" onclick="enablewebsite('+value.id+')"  id="enablewebsitebtn'+value.id+'" class="btn btn-xs btn-success" style="margin-right:3px;" ><i class="fa fa-check" aria-hidden="true"></i></a>';
										status = 'Inactive';
									}
									 ...
									 $('#dataTable').dataTable().fnAddData([
									  ...
									  ''!=null ? value.website  : "",
									  status,
									  '<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="return editwebsite('+value.id+',\''+value.name+'\''+',\''+value.company_size+'\''+',\''+ value.website +'\''+',\''+ value.fname+'\''+',\''+value.lname+'\''+',\''+value.email+'\''+',\''+value.phone+'\''+',\''+value.address+'\')"  class="btn btn-info btn-xs" style="margin-right:3px;" id="editwebsitebtn'+value.id+'"><i class="fa fa-pencil" aria-hidden="true"></i></a>'+link+
									  '<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="viewwebsite('+value.id+')"  class="btn btn-primary btn-xs" style="margin-right:3px;" id="viewwebsitebtn'+value.id+'"><i class="fa fa-eye" aria-hidden="true"></i></a>'
											]);
									i++;
								}); 
...
e.preventDefault();
  ...
  function editwebsite(id,name,company_size,website, fname, lname, email, phone, address){
    ...
    $('#addwebsitediv').addClass('hidden');
    $('#editwebsitediv').removeClass('hidden');
	$('#viewwebsitediv').addClass('hidden');		

   return false;
 }
 	$(".website-edit-back").click(function(){
		$("#editwebsitediv").addClass("hidden");
		$("#addwebsitediv").removeClass("hidden");
		$('#viewwebsitediv').addClass('hidden');
	});
...
else
{
  ...
  function viewwebsite(id){
            ...
            success: function(data) {
               ...
               $('#addwebsitediv').addClass('hidden');
			   $('#editwebsitediv').addClass('hidden');
			   $('#viewwebsitediv').removeClass('hidden');	
