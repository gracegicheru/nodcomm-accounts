		...
		$.ajax({
			...
			success:  function(data){
				...
				if(data.status == "success"){
					...
					$("#message").val('');
					var div='<div class="row msg_container base_receive"><div class="col-md-2 col-xs-2 avatar"><i class="fa fa-user" aria-hidden="true"></i></div><div class="col-md-10 col-xs-10"><div class="messages msg_receive"><p style="color:blue;">Me</p><p>'+data.details.description+'</p>';
