				...
				$('#dataTable').dataTable().fnClearTable();
								...
								$.each(data.details, function(key, value) {
									 $('#dataTable').dataTable().fnAddData([
									  ...
									  '<a  data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="editdepartment('+value.id+')"  class="btn btn-xs btn-info" style="margin-right:3px;" id="editdepartmentbtn'+value.id+'"><i class="fa fa-pencil" aria-hidden="true"></i></a>'
											]);
									i++;
								}); 
                    }
...
e.preventDefault();
 ...
 function editdepartment(id){
            ...
            success: function(data) {
               ...
               $('#adddepartmentdiv').addClass('hidden');
			   $('#updatedepartmentdiv').removeClass('hidden');
			   var ul='';
