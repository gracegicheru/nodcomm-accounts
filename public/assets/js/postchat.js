 ...
 function editfield(id){
            ...
            success: function(data) {
               ...
               $('#addfielddiv').addClass('hidden');
			   $('#editfielddiv').removeClass('hidden');
...
return false;
 	...
 	$(".field-edit-back").click(function(){
		$("#editfielddiv").addClass("hidden");
		$("#addfielddiv").removeClass("hidden");
	});
               ...
               if(data.status=='error'){
				...
				$('#dataTable').dataTable().fnClearTable();
								...
								$.each(data.details, function(key, value) {
									if(value.visible == 1){
										var visible = '<input type="checkbox" checked>';
									}else{
										var visible = '<input type="checkbox">';
									}
								    if(value.required == 1){
										var required = '<input type="checkbox" checked>';
									}else{
									 ...
									 $('#dataTable').dataTable().fnAddData([
									  ...
									  ''!=null ? required  : "",
									  ''!=null ? visible  : "",
									  '<a  data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" onclick="editfield('+value.id+')"  class="btn btn-xs btn-info" style="margin-right:3px;" id="editfieldbtn'+value.id+'"><i class="fa fa-pencil" aria-hidden="true"></i></a>'
											]);
									i++;
								}); 
