			...
			<div class="text-center" >
				...
				<div class="main-login main-center" id="step3div">
					...
					<ul class="nav nav-tabs">
								<li class="active" id="company" style="font-size: 25px;"><a href="" data-toggle="tab">Company</a></li>
								<li id="people" style="font-size: 25px;"><a href="" data-toggle="tab">Individual</a></li>
							</ul>
						</div>
