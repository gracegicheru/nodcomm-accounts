  ...
  <div class="row main" >
    <div class="text-center" >
     ...
     <form class="login-form" role="form" method="POST" action="{{ route('login.custom') }}" id="loginform">
       {{ csrf_field() }}
    <div class="form-group" id="errors" style="margin-top:20px;margin-bottom: 10px;margin-left: 50px;color: orangered; "> </div>

      <div class="row margin">
        <div class="input-field col s12">
          <i class="material-icons prefix pt-2">mail_outline</i>
          <input id="email" type="email" name="email" style="padding-left: 5px;">
          <label for="username" class="center-align" style="color: white; margin-top: -10px;">Enter Your Email</label>
        </div>
      </div>
      <div class="row margin">
        <div class="input-field col s12">
          <i class="material-icons prefix pt-2">lock_outline</i>
          <input id="password" type="password" name="password" style="padding-left: 5px;">
